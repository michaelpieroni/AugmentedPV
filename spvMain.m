function [ m ] = spvMain( im,type_map,mod_phos,box_margins,dist_elec,render_type,varargin)
...
switch (type_map)
    case{'Uniform'}
        ...
        tic  
         ...
         [ inte,spread ] = spvPhosphProcessor( im,type_map,mod_phos,dim_phos);
        toc
        
        tic
         % verify the content of render_type 
         [ m ] = spvPhosphRender( inte,spread, nRow_rend,nCol_rend, mod_phos); 
        toc
