function [ m ] = spvPhosphRender( inte,spread, nRow_rend,nCol_rend,mod_phos, varargin)
...
%   m: matrice contenente i dati dell'immagine che è stata fosfenizzata
    ...
    [ map ] = spvPhosphMap( 'Uniform',fr,fc,r_ph,c_ph );
...
% Per migliorare le prestazioni di questa funzione si potrebbe utilizzare
% un metodo analogo a quello di compressione delle immagini: dato un punto
% vengono controllati tutti i punti che lo cirdano e se questi risultano
% uguali allora ad essi verrà assegnato direttamente un valore senza
% calcolarselo.
